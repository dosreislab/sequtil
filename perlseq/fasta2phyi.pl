...
my $spacer = 10;
my $len = 100; # subsequence length for printing
my $labelsfile;

my $usage = "Usage:fasta2phyi.pl [co] LABELSFILE <FASTAIN >PHYIOUT";
