...
#
#
#  (c) 2007, 2009 Mario dos Reis
# 
#  with modifications for sequence hdrs. May 2009.
#  FIXME: not fully functional, formatting is not yet
#  as pretty as it should be!
